      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You have successfully logged out');
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    var url, res, msg, message;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/update-password' : 'http://127.0.0.1:3000/api/v1/users/update-me';
            console.log(data);
            _context.next = 5;
            return (0, _axios.default)({
              method: 'PATCH',
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              msg = type === 'password' ? 'Your password has been updated.' : 'Your user data has been updated.';
...
exports.resetPassword = exports.forgotPasswordTool = void 0;
...
var forgotPasswordTool = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Password Reset was sent to your email!');
              window.setTimeout(function () {
                location.assign(document.referrer);
              }, 1000);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/users/reset-password/".concat(resetToken),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your password was reset!');
              window.setTimeout(function () {
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmljZXBvbzEyMyIsImEiOiJja2c1MzFxNWMwcWtpMnFxbnl0bXJ0b3JoIn0.tTwmHIKnlS1NEEqBNtFecA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/ricepoo123/ckg534ywa1xnu19obr98hzn88',
    scrollZoom: false // center: [-118.137908, 34.156172],
    // zoom: 4,
    // interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Add Marker to mapbox
...
var userDataForm = document.querySelector('#user-data');
var userPasswordForm = document.querySelector('#user-password');
var forgotPasswordForm = document.querySelector('#forgot');
var resetPasswordForm = document.querySelector('#reset');
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.getElementById('email').value;
    (0, _resetPassword.forgotPasswordTool)(email);
  });
}
